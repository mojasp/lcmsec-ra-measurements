...
#ifndef __exlcm_muldim_array_t_hpp__
#define __exlcm_muldim_array_t_hpp__
...
int muldim_array_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int muldim_array_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int muldim_array_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t muldim_array_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* muldim_array_t::getTypeName()
{
    return "muldim_array_t";
}

int muldim_array_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int muldim_array_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int muldim_array_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t muldim_array_t::_computeHash(const __lcm_hash_ptr *)
{
